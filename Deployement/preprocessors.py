...
class Pipeline:
    ...
    def set_categorical_variables_to_inpute(self,list):
        self.categorical_variables_to_inpute = list
    def set_numerical_variables_to_inpute(self,list):
        self.numerical_variables_to_inpute = list
    def set_max_runtime_secs(self,value):
        self.max_runtime_secs = value
  ...
  # ======= Starting BY applying EFA ============
    ...
    def final_factors_and_names(self):
      ...
      #return factors_name
      self.EFA_Result = {"All columns analysed in EFA": loadings.index.tolist() , "\n Final factors Names": self.factors_names, "\nTotal cumulative variance explained by final factors ": cum_variance ,"\n More insights:": loadings  }
      ss1 = "All columns analysed in EFA \n"
      ss2 = "\n Final factors Names"
      ss3 = "\nTotal cumulative variance explained by final factors "
      ss4 = "\n More insights: \n"

      return  ss1 , loadings.index.tolist(), ss2,self.factors_names,ss3, cum_variance, ss4 , loadings
  ...
  # ======= Validation of EFA with CFA ============
    ...
    def apply_CFA(self):
      ...
      ss = "\n More Insights: \n "
      return Interpretation_CFA ,ss, covar , loadings_CFA
